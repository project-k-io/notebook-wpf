...
namespace Projects.Views
{
  public partial class TasksTreeView : UserControl, IComponentConnector
  {
    ...
    internal TreeListView treeViewTasks;
    ...
    private void TasksTreeView_Loaded(object sender, RoutedEventArgs e)
    {
      ...
      this.treeViewTasks.SelectItem((object) dataContext.Project.SelectedTreeTask);
    ...
    private void OnTreeViewKeyDown(object sender, KeyEventArgs e)
    {
      ...
      {
        TreeViewItem treeViewItem = treeView.ItemContainerGenerator.ContainerFromItem((object) task) as TreeViewItem;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Projects.Views;component/taskstreeview.xaml", UriKind.Relative));
    }
    ...
    {
      if (connectionId == 1)
        this.treeViewTasks = (TreeListView) target;
      else
        this._contentLoaded = true;
    }
  }
